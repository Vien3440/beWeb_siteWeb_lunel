 ...
 */
class NewsLetterFormulaire extends \AppBundle\Entity\NewsLetterFormulaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\NewsLetterFormulaire' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\NewsLetterFormulaire' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\NewsLetterFormulaire' . "\0" . 'texte', '' . "\0" . 'AppBundle\\Entity\\NewsLetterFormulaire' . "\0" . 'choix'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewsLetterFormulaire $proxy) {
