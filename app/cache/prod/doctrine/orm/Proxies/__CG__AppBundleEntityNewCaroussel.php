 ...
 */
class NewCaroussel extends \AppBundle\Entity\NewCaroussel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\NewCaroussel' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\NewCaroussel' . "\0" . 'text', '' . "\0" . 'AppBundle\\Entity\\NewCaroussel' . "\0" . 'images'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewCaroussel $proxy) {
