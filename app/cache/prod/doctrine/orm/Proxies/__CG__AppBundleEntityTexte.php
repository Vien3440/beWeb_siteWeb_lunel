 ...
 */
class Texte extends \AppBundle\Entity\Texte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Texte' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Texte' . "\0" . 'classe', '' . "\0" . 'AppBundle\\Entity\\Texte' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\Texte' . "\0" . 'texte'];
        }
