...
class Message extends \AppBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'mail', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'objet', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'sujet', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'statut'];
        }
